var mvi = {
    personSelected: function (id, name, ssn, dob, firstName, lastName) {
        ...
        var isActionItem = currentEntity == "mcs_tracker";
        ...
        CommCare.Shared.FormContext.data.save().then(() => {
            ...
            var SelectedPersonMetadata = this.getSelectedPersonMetadata(actionItemId, cleanID, previousVeteran, _icn, isActionItem);
    ...
    getSelectedPersonMetadata: function (ActionItemId, VeteranId, PreviousVeteranId, icn, isActionItem) {
                ...
                getMetadata: function () {
                    return {
                        ...
                        parameterTypes: {
                            ...
                            IsActionItem: { typeName: "Edm.Boolean", structuralProperty: 1 }
                        },
