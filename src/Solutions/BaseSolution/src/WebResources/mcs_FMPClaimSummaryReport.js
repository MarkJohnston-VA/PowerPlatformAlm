...
function DisplayReport(rpt) {
    ...
    try {
        ...
        var source = "DisplayRpt:userid="// + Xrm.Page.context.getUserId();
    }
}
...
function OnLoad(context) {
    ...
    CommCare.Shared.SetChildContext(CommCare.Shared.FormContext, "WebResource_mcs_FMPClaimSummaryReport");
}