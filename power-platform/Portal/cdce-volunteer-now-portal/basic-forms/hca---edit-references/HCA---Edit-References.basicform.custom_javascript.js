$(document).ready(
    function () {
        $("#cdcep_internationalreference").change(function () {
            let isInternational = document.getElementById("cdcep_internationalreference_1").checked; //$("#cdcep_internationalreference").val();
            debugger;
        ...
        if (document.getElementById("cdcep_internationalreference_1").checked) {
            removePhoneNumberValidation("cdcep_phonenumber");
        }
        else {
            addPhoneNumberValidation("cdcep_phonenumber");
