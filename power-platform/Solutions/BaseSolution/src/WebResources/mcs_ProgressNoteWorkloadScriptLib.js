...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//GLM - 11/05/2019 - added for CM story 1156381: Facility selected during the MVI Search will be the default selection
var viawl_mvi_SelectedFacilityCode = null;
var viawl_mvi_SelectedFacilityName = null;
var viawl_mvi_SelectedFacilityCRMID = null;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function viawl_onTransportReadNoteTitle_response(viawl_error, viawl_getnotetitlesresponse, viawl_externalObject) {
    ...
    try {
        ...
        var x = document.getElementById("selFreqUsedNoteTitle");
        ...
        if (viawl_getnotetitlesresponse.noteTitles.results.length > 0) {
            ...
            for (var i = 0; i <= viawl_notetitlesArray.length - 1; i++) {
                ...
                for (var ii = 0; ii <= viawl_notetitlesArray[i].taggedResults.length - 1; ii++) {
                    ...
                    option.text = viawl_notetitlesArray[i].taggedResults[ii].textArray[0];
                    x.add(option);
...
function viawl_onSelectNoteTitle(e) {
    try {
        ...
        parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitletext").setValue(viawl_dataItem.name);
        parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitletext").setSubmitMode('always');
        parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitleid").setValue(viawl_dataItem.id);
        parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitleid").setSubmitMode('always');
    }
    catch (err) {
...
function viawl_onChangeNoteTitle(e) {
    try {
        ...
        if (!viawl_isValidNoteTitle) {
            e.sender.value("");
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitletext").setValue(null);
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitletext").setSubmitMode('always');
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitleid").setValue(null);
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitleid").setSubmitMode('always');
        }
    }
    catch (err) {
...
function viawl_onTransportReadLocation_response(viawl_error, viawl_getlocationsresponse, viawl_externalObject) {
    ...
    try {
        ...
        //Get VIA service Response
        var x = document.getElementById("selFreqUsedLocation");
        if (viawl_getlocationsresponse.locations.resultsInfo.length > 0) {
            ...
            for (var i = 0; i <= viawl_locationsArray.length - 1; i++) {
                ...
                var option = document.createElement("option");
                option.text = viawl_locationsArray[i].name;
                x.add(option);
...
function viawl_onSelectLocation(e) {
    try {
        ...
        var viawl_dataItem = this.dataItem(e.item.index());
        parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setValue(viawl_dataItem.name);
        parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setSubmitMode('always');
        parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid").setValue(viawl_dataItem.id);
        parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid").setSubmitMode('always');
    }
    catch (err) {
...
function viawl_onChangeLocation(e) {
    try {
        ...
        if (!viawl_isValidLocation) {
            e.sender.value("");
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setValue(null);
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setSubmitMode('always');
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid").setValue(null);
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid").setSubmitMode('always');
        }
    }
    catch (err) {
...
function viawl_formLoad() {
    ...
    if (sessionStorage.SelectedFacilityCode != null) {
        viawl_mvi_SelectedFacilityCode = sessionStorage.SelectedFacilityCode;
        sessionStorage.removeItem("SelectedFacilityCode");
    }

    if (sessionStorage.SelectedFacilityName != null) {
        viawl_mvi_SelectedFacilityName = sessionStorage.SelectedFacilityName;
        sessionStorage.removeItem("SelectedFacilityName");
    }

    if (sessionStorage.SelectedFacilityCRMID != null) {
        viawl_mvi_SelectedFacilityCRMID = sessionStorage.SelectedFacilityCRMID;
        sessionStorage.removeItem("SelectedFacilityCRMID");
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    try {
        debugger;
        vialib_getConfig(); //getConfig();

        ////////////////////////////////////////////////////////////////////////////////////
        ///////////// PV - REMOVING AUTOCOMPLETE FUNCTIONALITY FOR NOW  ////////////////////
        ////////////////////////////////////////////////////////////////////////////////////
        //
        //
        ...
        if (viawl_ViaLoginCookie == null || viawl_ViaLoginCookie == '' || viawl_ViaLoginCookie == "undefined") {
            //empty mcs_selectedworkloadlocationtext, mcs_selectedworkloadnotetitletext, mcs_progressnotefacility
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setValue();
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitletext").setValue();
            parent.Xrm.Page.getAttribute("mcs_progressnotefacility").setValue();
            ...
            viawl_getMultipleEntityDataAsync('mcs_settingSet', 'mcs_VIAServiceBaseURL, mcs_VIARequestingApplicationCode, mcs_VIAConsumingApplicationToken, mcs_VIAConsumingApplicationPassword', viawl_conditionalFilter, 'mcs_name', 'asc', 0, viawl_SettingsWebServiceURL_response, '');
            ...
            if (viawl_ViaLoginData && viawl_ViaLoginData.length) {
                ...
                for (var i = 0; i < viawl_ViaLoginData.length; i++) {
                    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    //GLM - 11/05/2019 - added for CM story 1156381: Facility selected during the MVI Search will be the default selection					
                    if (viawl_mvi_SelectedFacilityCRMID == null)
                        viawl_mvi_SelectedFacilityCRMID = "";
                    if (viawl_ViaLoginData[i].facilityId.toLowerCase() == viawl_mvi_SelectedFacilityCRMID.toLowerCase())
                        $("#selSite").append("<option data-providername='" + viawl_ViaLoginData[i].providerName + "' data-duz='" + viawl_ViaLoginData[i].duz + "' data-sitecode='" + viawl_ViaLoginData[i].siteCode + "' value='" + viawl_ViaLoginData[i].facilityId + "' selected=true>" + viawl_ViaLoginData[i].siteName + "</option>");
                    else
                ...
                var pFacility = parent.Xrm.Page.getAttribute("mcs_progressnotefacility");
                var pLocation = parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid");
                var pNote = parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitleid");
                if (pFacility != null)
            ...
            var columns = "mcs_dacurl, mcs_vialoginurl, mcs_vialoginminutes, mcs_viassoiloginurl, mcs_viassoirefreshtokenurl, mcs_viassoipivcardurl, mcs_viaservicebaseurl, mcs_viarequestingapplicationcode, mcs_viaconsumingapplicationtoken, mcs_viaconsumingapplicationpassword, mcs_mvisubscriptionkey";
            var filter = "$filter=mcs_name eq 'Active Settings'";

            CommCare.Shared.CrmCommonJS.WebApi.RetrieveMultiple("mcs_settings", columns, filter).then(function (settings) {
                if (settings.value != null) {
                    // CdS - try to get locations
                    //viawl_onTransportReadLocation();
                    ...
                    var viawl_locSortChar = "991"; //viawl_LocationText.toUpperCase();
                    var viawl_locSortDir = "1";

                    var columns = "bah_stationsuffix_text,bah_facilityid,bah_name";
                    var filter = "$filter=bah_facilityid eq " + viawl_userSiteId;

                    CommCare.Shared.CrmCommonJS.WebApi.RetrieveMultiple("bah_facilities", columns, filter).then(function (results) {
                        console.log("Facilities successfully retrieved:");

                        if (results.value != null) {
                            for (var i = 0; i < results.value.length; i++) {
                                //var ftp_facilitycode_text = results.value[i]["bah_stationsuffix_text"];
                                //var ftp_facilityid = results.value[i]["bah_facilityid"];
                                viawl_UserSiteNo = results.value[i]["bah_stationsuffix_text"]; //results.value[i]["bah_name"];
                                break;
                            }
                        }

                        //Decrypt VIA Service Connector Items
                        var viawl_requestingApp = viawl_decryptServiceConnector(settings.value[0].mcs_viarequestingapplicationcode, 4);
                        var viawl_consumingAppToken = viawl_decryptServiceConnector(settings.value[0].mcs_viaconsumingapplicationtoken, 6);
                        var viawl_consumingAppPassword = viawl_decryptServiceConnector(settings.value[0].mcs_viaconsumingapplicationpassword, 8);


                        //vialib_getLocations(viawl_requestingApp, viawl_consumingAppToken, viawl_consumingAppPassword, viawl_baseServiceEndpointUrl, viawl_providername, viawl_duz, viawl_UserSiteNo, viawl_locSortChar, viawl_locSortDir, viawl_onTransportReadLocation_response, e);
                        vialib_getLocations(viawl_requestingApp, viawl_consumingAppToken, viawl_consumingAppPassword, settings.value[0].mcs_viaservicebaseurl, viawl_providername, viawl_duz, viawl_UserSiteNo, viawl_locSortChar, viawl_locSortDir, viawl_onTransportReadLocation_response, null);

                        vialib_getNoteTitles(viawl_requestingApp, viawl_consumingAppToken, viawl_consumingAppPassword, settings.value[0].mcs_viaservicebaseurl, viawl_providername, viawl_duz, viawl_UserSiteNo, viawl_locSortChar, viawl_locSortDir, viawl_onTransportReadNoteTitle_response, null);
            ...
            if (viawl_entityName == 'incident') {
                ...
                var viawl_noteType = parent.Xrm.Page.getAttribute("mcs_notetype_code").getValue();
...
function viawl_selectSite(site, location, note) {
    try {
        ...
        if (location == 'from' && note == 'dropdown') {
            //location = parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid");
            //note = parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitleid");
            location = null;
            note = null;
            ...
            site = [{ entityType: "mcs_facility", id: tempVal, name: tempText }];
            //viawl_testPatient(0);
        }
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //GLM - 11/05/2019 - added for CM story 1156381: Facility selected during the MVI Search will be the default selection					
        if (viawl_mvi_SelectedFacilityCRMID == null || viawl_mvi_SelectedFacilityCRMID == "") {
            //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            if (site) {
        ...
        if (viawl_userSiteId != null && viawl_userSiteId != '') {
            try {
                ...
                parent.Xrm.Page.getAttribute("mcs_progressnotefacility").setSubmitMode('always');
            } catch (e) {
                parent.Xrm.Page.getAttribute("mcs_progressnotefacility").setValue([{
                    id: viawl_userSiteId,
                    name: $('#selSite').find(":selected").text(),
            ...
            CommCare.Shared.CrmCommonJS.WebApi.RetrieveMultiple("bah_facilities", columns, filter).then(function (results) {
                ...
                if (results.value != null) {
                    for (var i = 0; i < results.value.length; i++) {
                        //var ftp_facilitycode_text = results.value[i]["bah_stationsuffix_text"];
                        //var ftp_facilityid = results.value[i]["bah_facilityid"];
                        var viawl_UserSiteNo = results.value[i]["bah_name"];
                        break;
                    }
                }
...
function viawl_SettingsWebServiceURL_response(viawl_settingData, viawl_lastSkip, viawl_Blank_NA) {
    try {
        ...
        for (var i = 0; i <= viawl_settingData.d.results.length - 1; i++) {
            //Get info
            if (viawl_settingData.d.results[i].mcs_VIAServiceBaseURL != null) { viawl_baseServiceEndpointUrl = viawl_settingData.d.results[i].mcs_VIAServiceBaseURL; }
            if (viawl_settingData.d.results[i].mcs_VIARequestingApplicationCode != null) { viawl_requestingApp = viawl_settingData.d.results[i].mcs_VIARequestingApplicationCode; }
            if (viawl_settingData.d.results[i].mcs_VIAConsumingApplicationToken != null) { viawl_consumingAppToken = viawl_settingData.d.results[i].mcs_VIAConsumingApplicationToken; }
            if (viawl_settingData.d.results[i].mcs_VIAConsumingApplicationPassword != null) { viawl_consumingAppPassword = viawl_settingData.d.results[i].mcs_VIAConsumingApplicationPassword; }
            break;
        }
...
function getDefaultGroupIDFromSiteName(siteCode) {
    ...
    req.open("GET", Xrm.Page.context.getClientUrl() + "/api/data/v8.2/bah_facilities?$select=bah_facilityid,bah_name&$filter=bah_stationsuffix_text eq '" + siteCode + "'", false);
    ...
    req.onreadystatechange = function () {
        if (this.readyState === 4) {
            ...
            if (this.status === 200) {
                ...
                for (var i = 0; i < results.value.length; i++) {
                    var mcs_facilityid = results.value[i]["bah_facilityid"];
                    var mcs_name = results.value[i]["bah_name"];
                    siteName = mcs_name;
                    facilityId = mcs_facilityid;

                    var req1 = new XMLHttpRequest();
                    var url = Xrm.Page.context.getClientUrl() + "/api/data/v8.2/mcs_facilitygroupdefaults?$select=mcs_facilitygroupdefaultid&$filter=_mcs_facilitysiteid_value eq " + facilityId;
                    ...
                    req1.onreadystatechange = function () {
                        if (this.readyState === 4) {
                            ...
                            if (this.status === 200) {
                                var results = JSON.parse(this.response);
                                for (var i = 0; i < results.value.length; i++) {
                                    var mcs_facilitygroupdefaultid = results.value[i]["mcs_facilitygroupdefaultid"];
                                    groupID = mcs_facilitygroupdefaultid;
                                }
                            } else {
                                Xrm.Utility.alertDialog(this.statusText);
                            }
...
function viawl_populateFrequentlyUsed(viawl_retryCount, location, note) {
    try {
        ...
        if (!note) {
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitletext").setValue();
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitletext").setSubmitMode('always');
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitleid").setValue();
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitleid").setSubmitMode('always');
        }
        if (!location) {
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setValue();
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setSubmitMode('always');
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid").setValue();
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid").setSubmitMode('always');
        }
        ...
        if (viawl_facilityGroupDefaultId != null && viawl_facilityGroupDefaultId != "") {
            ...
            var viawl_facilityGroupDefaultData = viawl_getSingleEntityDataSync('mcs_facilitygroupdefaultSet', 'mcs_frequentlyusednotetitles, mcs_frequentlyusedlocations', viawl_facilityGroupDefaultId);
            if (viawl_facilityGroupDefaultData != null) {
                if (viawl_facilityGroupDefaultData.d.mcs_frequentlyusednotetitles != null) {
                    viawl_frequentlyUsedNoteTitles = viawl_facilityGroupDefaultData.d.mcs_frequentlyusednotetitles;
                }
                if (viawl_facilityGroupDefaultData.d.mcs_frequentlyusedlocations != null) {
                    viawl_frequentlyUsedLocations = viawl_facilityGroupDefaultData.d.mcs_frequentlyusedlocations;
                }
            }
        ...
        //mcs_viaworkloadencounterlocationdefault:"3901~~TCP-RENO",
        //mcs_viaworkloadencounternotetitledefault:"1435~~C&P AUDIOLOGY EXAM",
...
function viawl_getFacilityGroupDefaults() {
    try {
        ...
        $.ajax({
            ...
            datatype: "json",
            url: Xrm.Page.context.getClientUrl() + "/api/data/v8.2/mcs_facilitygroupdefaults(" + gbl_vcmn_facilityGroupDefaultId + ")?$select=mcs_viaworkloadencounterlocationdefault,mcs_viaworkloadencounternotetitledefault",
            ...
            success: function (data, textStatus, xhr) {
                var result = data;
                var mcs_viaworkloadencounterlocationdefault = result["mcs_viaworkloadencounterlocationdefault"];
                var mcs_viaworkloadencounternotetitledefault = result["mcs_viaworkloadencounternotetitledefault"];

                gbl_viawl_facilitygroupdefaultvalues =
				{
				    viaworkloadencounterlocationdefault: mcs_viaworkloadencounterlocationdefault,
				    viaworkloadencounternotetitledefault: mcs_viaworkloadencounternotetitledefault
				};
            },
...
function viawl_selectFreqUsedNoteTitle() {
    ...
    try {
        ...
        if (viawl_freqNoteTitleValue != "00") {
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitletext").setValue(viawl_freqNoteTitleText);
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitleid").setValue(viawl_freqNoteTitleValue);
        }
        else {
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitletext").setValue(null);
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadnotetitleid").setValue(null);
...
function viawl_selectFreqUsedLocation() {
    ...
    try {
        ...
        if (viawl_freqLocationValue != "00") {
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setValue(viawl_freqLocationText);
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid").setValue(viawl_freqLocationValue);
        }
        else {
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setValue(null);
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid").setValue(null);
...
function viawl_testPatient(viawl_retryCount) {
    try {
        ...
        if (viawl_entityName == 'incident') {
            ...
            viawl_crmVeteranId = parent.Xrm.Page.getAttribute("mcs_patient").getValue();
        }
...
function viawl_selectVisit() {
    try {
        ...
        if (viawl_VisitValueId != "00") {
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setValue(viawl_VisitValueText);
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid").setValue(viawl_VisitValueId);
            ...
            if (viawl_VisitValueDateTime != null && viawl_VisitValueDateTime != "") {
                ...
                parent.Xrm.Page.getAttribute("mcs_userentrydate").setValue(viawl_visitEntryDateTime);
            }
            else {
                parent.Xrm.Page.getAttribute("mcs_userentrydate").setValue(null);
            }
        }
        else {
            parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setValue(null);
        ...
        parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationtext").setSubmitMode('always');
        parent.Xrm.Page.getAttribute("mcs_selectedworkloadlocationid").setSubmitMode('always');
        parent.Xrm.Page.getAttribute("mcs_userentrydate").setSubmitMode('always');
    }
    catch (err) {
